                    ...
                    .columns.is-mobile
                      ...
                      .column.centered(v-if="map.type !== 'Control'")
                        .wrap(v-bind:class="{'chosen': checkWinner('draw', index)}")
                          img.round-winner.is-draw(src="/static/img/tie.svg", v-on:click="setMapWinner('draw', index)")
                    ...
                    .columns.is-mobile
                      ...
                      .column.centered
                        .wrap(v-bind:class="{'chosen': tieWinner('none')}")
                          img.round-winner.is-draw(src="/static/img/tie.svg", v-on:click="setTieWinner('none')")
                      .column.centered
                ...
                .column
                  .notification.is-warning 
                    p * If you believe the map won't be played, please choose 
                      img(src="/static/img/tie.svg" style="height: 1rem; width: 1rem;")
                      | .  Thank you!
  ...
  export default {
    ...
    methods: {
      ...
      getBgImage: function (name) {
        name = name.replace('\'', '')
        return '/static/img/maps/' + name + '.jpg'
      },
