              ...
              .columns.is-mobile
                .column.centered
                  a(href="https://discord.gg/H5bNcYD" target="_blank")
                    img.social-icon(src="/static/img/discord.svg" alt="Discord")
                .column.centered
                  a(href="https://www.reddit.com/r/highnoonpickem" target="_blank")
                    img.social-icon(src="/static/img/reddit.svg" alt="Reddit")
                .column.centered
                  a(href="https://twitter.com/highnoonpickem" target="_blank")
                    img.social-icon(src="/static/img/twitter.svg" alt="Twitter")
