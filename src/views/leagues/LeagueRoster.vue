  ...
  .league-roster(v-if="playersLoaded")
    ...
    section.is-hidden-desktop(v-if="hasRoster")
      h2.ow-font.mobile-roster
        ...
        span.orange {{ weeklyPoints['captain'] }}
      h2.ow-font
